...
export default function Header() {
  ...
  return (
    <header className="relative z-[99]">
      <motion.div
        className="fixed left-1/2 top-0 h-[4.5rem] w-full rounded-none md:border bg-[#03001417] md:border-[#f4f3ee] md:border-opacity-40 bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] md:w-[33.5rem] md:rounded-full"
