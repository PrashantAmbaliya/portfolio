...
export default function RedoTextAnimation({ delay }: IRedoTextAnimationProps) {
  ...
  return (
    <motion.span 
    className="h-32 max-w-96 bg-purple-100 text-[1.2rem] font-bold dark:bg-purple-600 md:text-[1.5rem] lg:text-[1.7rem]"
    // className="h-32 max-w-96 text-[1.2rem] font-bold bg-gradient-to-r from-purple-600 to-cyan-500 bg-clip-text text-transparent dark:from-purple-500 dark:to-cyan-500 md:text-[1.5rem] lg:text-[2rem]"
    >
      {displayText}
    </motion.span>
  );
