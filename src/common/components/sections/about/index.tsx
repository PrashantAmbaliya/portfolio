      ...
      <div className="flex w-full flex-col items-center pt-8">
        ...
        >
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                ...
                <p className="flex flex-col items-start sm:items-center lg:items-start">
                  ...
                  >
                    <span className="bg-purple-200 text-2xl font-bold uppercase dark:bg-purple-400 lg:normal-case">
                      Contact me!
                    </span>
                  </Link>
                </p>
            ...
            <div className="flex justify-center lg:absolute lg:left-0 lg:top-1/4 lg:block">
              <div className="relative mt-10 sm:mt-0 h-72 w-72 lg:h-[380px] lg:w-[380px] xl:h-[470px] xl:w-[470px]">
                <div className="hidden sm:block absolute inset-0 z-20 rounded-full bg-gradient-to-b from-purple-200 via-purple-300 to-purple-400 transition-opacity group-hover:opacity-0" />
                <div className="absolute inset-0">
                  <Image
                    ...
                    width={470}
                    height={470}
                    className="z-10 object-cover rounded-full lg:h-[380px] lg:w-[380px] xl:h-[470px] xl:w-[470px]"
                  />
                </div>
              </div>
            </div>
