      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {skills.map((skill, index) => (
          ...
          >
            ...
            />
            <span className="text-sm sm:text-lg Welcome-text dark:text-white/80">
              {skill.skill_name}
            </span>
          </motion.div>
        ))}
...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      ref={ref}
      className="flex w-full flex-col items-center justify-center py-24 text-center dark:bg-darkBg dark:text-white overflow-hidden"
    >
      ...
      <div className="flex w-full justify-center dark:bg-darkBg mt-[100px]">
        <SectionDivider />
      </div>
    </section>
  );
